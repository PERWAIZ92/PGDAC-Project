...
<body class="login-bg">
	...
	<div class="page-content container">
		<div class="row">
			...
			<!--  	<form th:action="@{/saveCustomers}" th:object="${customer}" method="POST">-->
					<form:form modelAttribute="newContact" th:action="@{/saveCustomers}" th:object="${customer}" method="POST">
								<label>Name*</label>
								...
								<select class="form-control" path="country" name="countryCode"
									id="">
									<option data-countryCode="GB" value="44" Selected>UK
										(+44)</option>
